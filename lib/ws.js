        ...
        if (action === 'enter') {
            ...
            this.ws.on('message', (msg) => {
                ...
                this.queue.sending = this.queue.sending.filter(({ cb, defer }) => {
                    ...
                    if (!cb.m(data))
                        return true;
                    (_a = cb.cb) === null || _a === void 0 ? void 0 : _a.call(cb, data);
                    defer === null || defer === void 0 ? void 0 : defer[!isError ? 'resolve' : 'reject'](data);
                    return false;
                });
                this.doQueue();
            });
    ...
    terminate() {
        ...
        this.lns = {};
        {
            ...
            for (let data of this.queue.waits) {
                (_b = (_a = data.cb) === null || _a === void 0 ? void 0 : _a.cb) === null || _b === void 0 ? void 0 : _b.call(_a, err);
                (_c = data.defer) === null || _c === void 0 ? void 0 : _c.reject(err);
            }
            for (let data of this.queue.sending) {
                (_e = (_d = data.cb) === null || _d === void 0 ? void 0 : _d.cb) === null || _e === void 0 ? void 0 : _e.call(_d, err);
                (_f = data.defer) === null || _f === void 0 ? void 0 : _f.reject(err);
            }
